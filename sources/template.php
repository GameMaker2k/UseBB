...
class template
{
     ...
     * @access private
     */
    public $loaded_sections = array();
    public $templates = array();
    public $requests = array();
    public $global_vars = array();
    public $raw_contents = array();
    public $js_onload = array();
    public $breadcrumbs = array();
    public $config_debug = true;
    /**#@-*/
     ...
     */
    public function get_config($setting)
    {
     ...
     */
    public function parse($name, $section, $variables = array(), $is_special = false, $enable_token = false)
    {
     ...
     * @param array $variables Template variables
     */
    public function install_token(&$variables)
    {
     ...
     */
    public function add_global_vars($variables, $override = false)
    {
     ...
     */
    public function add_breadcrumb($title, $link_args = null, $hash = null)
    {
     ...
     */
    public function add_raw_content($content, $strip_slashes = true)
    {
     ...
     */
    public function set_js_onload($statement)
    {
     ...
     */
    public function compress_sourcecode($string)
    {
