...
if (defined('RUN_MODULE')) {
    ...
    class usebb_module
    {
        public function stage_topic_counts()
        {
        ...
        public function stage_topic_posts()
        {
        ...
        public function stage_forum_counts()
        {
        ...
        public function stage_forum_topics()
        {
