...
class admin_functions
{
     ...
     */
    public $acp_modules = array();
    /**
     * @var array Contains filenames of available ACP modules.
     */
    public $acp_modules_files = array();
    /**
     * @access private
     */
    public $all_forums;
     ...
     */
    public function check_module($module_name, $actual_module_name = '')
    {
     ...
     */
    public function run_module($module_name)
    {
     ...
     */
    public function create_acp_menu($location)
    {
     ...
     */
    public function create_body($location, $content)
    {
     ...
     */
    public function make_php_string($variable)
    {
     ...
     */
    public function set_config($settings)
    {
     ...
     */
    public function forum_select_box($input_name, $multiple = true, $filter_ids = array(), $add = '')
    {
     ...
     */
    public function delete_forums($condition, $change_stats = true)
    {
     ...
     */
    public function delete_members($condition, $delete_posts = false, $ban_email = false)
    {
     ...
     */
    public function reload_moderator_perms()
    {
     ...
     */
    public function get_forums_array()
    {
     ...
     */
    public function set_acp_msg($msg)
    {
