...
class functions
{
    ...
    public $board_config_original = array();
    public $board_config_defined = array();
    public $statistics = array();
    public $languages = array();
    public $language_sections = array();
    public $mod_auth;
    public $badwords;
    public $updated_forums;
    public $available = array('templates' => array(), 'languages' => array());
    public $db_tables = array();
    public $server_load;
    public $is_mbstring;
    public $date_format_from_db = false;
    /**#@-*/

    /**
     * @access private
     */
    public function usebb_die($errno, $error, $file, $line)
    {
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
     ...
     */
    public function get_config($setting, $original = false)
    {
     ...
     */
    public function set_stats($stat, $value, $add = false)
    {
     ...
     * @returns string URL
     */
    public function _make_friendly_url($filename, $vars)
    {
     ...
     * @returns string URL
     */
    public function make_url($filename, $vars = array(), $html = true, $enable_sid = true, $force_php = false, $enable_token = false)
    {
     ...
     * @returns string URL
     */
    public function attach_sid($url)
    {
     ...
     */
    public function fetch_language($language = '', $section = '')
    {
     ...
     */
    public function redir_to_login()
    {
     ...
     * @returns string Date
     */
    public function make_date($stamp, $format = '', $keep_gmt = false, $translate = true)
    {
     ...
     */
    public function time_past($timestamp, $until = null)
    {
     ...
     * @returns string HTML
     */
    public function show_email($user)
    {
     ...
     */
    public function string_to_entities($string)
    {
     ...
     */
    public function random_key($is_password = false)
    {
     ...
     */
    public function usebb_mail($subject, $rawbody, $bodyvars = array(), $from_name, $from_email, $to, $bcc_email = '', $language = '', $charset = '')
    {
     ...
     */
    public function set_al($user_id, $passwd_hash)
    {
     ...
     */
    public function auth($auth_int, $action, $forum_id, $self = true, $alternative_user_info = null)
    {
     ...
     */
    public function get_mods_list($forum, $listarray = false)
    {
     ...
     * @returns string HTML
     */
    public function make_page_links($pages_number, $current_page, $items_number, $items_per_page, $page_name, $page_id_val = null, $back_forward_links = true, $url_vars = array(), $force_php = false)
    {
     ...
     */
    public function bbcode_clear($string)
    {
     ...
     */
    public function post_empty(&$string)
    {
     ...
     */
    public function bbcode_prepare($string)
    {
     ...
     * @returns string HTML
     */
    public function markup($string, $bbcode = true, $smilies = true, $html = false, $rss_mode = false, $links = true)
    {
     ...
     */
    public function get_bbcode_controls($links = true)
    {
     ...
     */
    public function get_smiley_controls()
    {
     ...
     */
    public function replace_badwords($string)
    {
     ...
     */
    public function timezone_handler($action, $param = null)
    {
     ...
     * @returns string HTML
     */
    public function make_profile_link($user_id, $username, $level, $title = null)
    {
     ...
     */
    public function forum_stats_box()
    {
     ...
     */
    public function get_server_load($which = 1)
    {
     ...
     */
    public function forum_icon($id, $open, $post_time)
    {
     ...
     */
    public function topic_icon($id, $locked, $post_time)
    {
     ...
     */
    public function birthday_input_fields($input)
    {
     ...
     */
    public function get_template_sets()
    {
     ...
     */
    public function get_usebb_tables()
    {
     ...
     */
    public function redirect($page, $vars = array(), $anchor = '')
    {
     ...
     * @param string $url URL
     */
    public function raw_redirect($url)
    {
     ...
     * @returns bool Valid
     */
    public function validate_password($password, $extended = false)
    {
     ...
     */
    public function generate_antispam_question($mode)
    {
     ...
     */
    public function pose_antispam_question()
    {
     ...
     */
    public function verify_token($try_token)
    {
     ...
     */
    public function token_error($type)
    {
     ...
     * @returns bool Verified
     */
    public function verify_form($enable_message = true)
    {
     ...
     * @returns bool Verified
     */
    public function verify_url($enable_message = true)
    {
     ...
     */
    public function sfs_api_request($email)
    {
     ...
     * @returns bool Banned
     */
    public function sfs_email_banned($email)
    {
     ...
     */
    public function sfs_api_submit($data)
    {
     ...
     */
    public function user_active_value($user = null, $new_post = false, $activate = false)
    {
     ...
     */
    public function antispam_is_potential_spammer($user, $new_post = false)
    {
     ...
     */
    public function antispam_can_post_links($user, $new_post = false)
    {
     ...
     */
    public function antispam_can_add_profile_links($user)
    {
